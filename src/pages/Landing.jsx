...
import { ArrowRight, BarChart3, ChevronLeft, ChevronRight, CreditCard, Megaphone, Menu, MessageCircle, Music2, PackageCheck, ShoppingBag, Users, Youtube } from 'lucide-react';
...
export default function Landing(){
 return <div className="lp-page">
  ...
  <footer id="contato" className="lp-footer"><div className="lp-wrap lp-footer-grid"><div><img src={peddiLogo} alt="PEDDI"/><p>Simples para pedir,<br/><strong>fácil para vender.</strong></p></div><div><b>Menu</b><a href="#inicio">Home</a><a href="#sobre">Sobre nós</a><a href="#recursos">Funcionalidades</a><a href="#planos">Planos</a></div><div><b>Contato</b><a href="mailto:contato@peddi.com.br">contato@peddi.com.br</a><span>Brasília — DF</span><div className="lp-social"><a href="https://www.tiktok.com/@peddi.oficial" target="_blank" rel="noreferrer" aria-label="TikTok da PEDDI" title="TikTok"><Music2/></a><a href="https://www.youtube.com/@peddi.oficial" target="_blank" rel="noreferrer" aria-label="YouTube da PEDDI" title="YouTube"><Youtube/></a></div></div></div><div className="lp-wrap lp-legal"><span>© {new Date().getFullYear()} PEDDI. Todos os direitos reservados.</span><span>Política de Privacidade · Termos de Uso</span></div></footer>
 </div>
}
