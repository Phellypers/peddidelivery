...
export default function LandingPreview(){
 return <div className="lp-page">
  <header className="lp-header"><div className="lp-wrap lp-nav">
    <Link to="/landing-preview" className="lp-logo"><img src={peddiLogo} alt="PEDDI"/></Link>
  ...
  <main>
   ...
   <section id="recursos" className="lp-section"><div className="lp-wrap lp-split"><div><span className="lp-eyebrow">Tudo em um só lugar</span><h2>Tudo que seu restaurante precisa para <em>vender mais.</em></h2><p>A PEDDI organiza seu atendimento, pedidos e operação para você concentrar energia no crescimento do seu negócio.</p><Button>Conheça as funcionalidades</Button></div><div className="lp-feature-art"><div className="lp-blob lp-blob--soft"></div><Media label="Imagem — gestora usando o sistema" className="lp-media--feature"/>{features.map(([Icon,label],i)=><span key={label} className={`lp-chip lp-chip--${i+1}`}><Icon size={17}/>{label}</span>)}</div></div></section>

   <section className="lp-section lp-menu-showcase"><div className="lp-wrap lp-split lp-split--reverse"><div className="lp-feature-art"><div className="lp-blob"></div><Media label="Imagem — celular com cardápio" className="lp-media--phone"/><span className="lp-cart"><ShoppingBag/></span></div><div><span className="lp-eyebrow">A cara da sua marca</span><h2>Um cardápio digital <em>com a cara do seu negócio.</em></h2><p>Personalize sua vitrine, destaque seus produtos, adicione fotos e receba pedidos de forma prática e organizada.</p><Button to="/loja?demo=1">Ver exemplo de cardápio</Button></div></div></section>
