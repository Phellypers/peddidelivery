...
export default function ProductDetail() {
  ...
  if (!product) {
    return <div className="min-h-screen flex flex-col items-center justify-center bg-background"><p className="text-muted-foreground">Item não encontrado</p><Link to="/" className="text-primary mt-2">Voltar ao cardápio</Link></div>;
  }
  ...
  const handleAdd = () => {
    addItem(product, quantity, variationString, selectedAddons, notes);
    setAdded(true);
        ...
        <div className="md:w-1/2 md:flex-shrink-0">
          <div className="relative md:rounded-2xl md:overflow-hidden">
            ...
            <div className="absolute left-4 right-4 flex justify-between" style={{ top: 'calc(1rem + env(safe-area-inset-top))' }}>
              <Link to="/" className="w-10 h-10 bg-card/80 backdrop-blur-sm rounded-full flex items-center justify-center shadow-sm">
                <ArrowLeft size={20} />
              </Link>
              <button
        ...
        <div className="max-w-2xl mx-auto space-y-2">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-1 gap-2">
              ...
              <button
                onClick={() => { addItem(product, quantity, variationString, selectedAddons, notes); navigate('/checkout'); }}
